...
class Produk extends Rest_Controller {
    ...
    public function index_get()
    {
        ...
        if ($data != null) {
	        foreach ($data as $key => $value) {
                $data[$key]['foto_produk'] = isset($value['foto_produk']) ?  base_url('assets/foto_produk/').$value['foto_produk'] : "";
	        }
        }
        $json_data = array(
        	'status'=>$status,
    ...
    {    
        ...
        if ($data != null) {
		    ...
		    $data['foto_produk'] = isset($data['foto_produk']) ?  base_url('assets/foto_produk/').$data['foto_produk'] : "";
        }
