    ...
    */
    ...
    $.addFlex = function (t, p) {
        ...
        if (p.usepager) {
            ...
            $(g.bDiv).after(g.pDiv);
            var html = ' <div class="pGroup"> <div class="pFirst pButton"><span></span></div><div class="pPrev pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pcontrol">' + p.pagetext + ' <input id="current_page" type="text" size="3" value="1" /> ' + p.outof + ' <span> 1 </span></span></div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pNext pButton"><span></span></div><div class="pLast pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
            ...
            if (p.useRp) {
                ...
                $('.pDiv2', g.pDiv).prepend('<div class="pGroup"><select id="sgrouprp" name="rp">' + opt + '</select></div> <div class="btnseparator"></div>');
            ...
            if (p.searchitems) {
                ...
                var sdate = '<span id="' + t.id + '_sdate" style="display:none;" class="sdate"><input id="sfrom" type="text" data-date-format="dd-mm-yyyy" size="20" value="' + p.date_start + '" name="qdatestart"> - <input id="sto" type="text" data-date-format="dd-mm-yyyy" size="20" value="' + p.date_end + '" name="qdateend"></span>';
                ...
                */
                ...
                $("#sfrom").datepicker({
                    ...
                    $("#sfrom").datepicker("option", "startDate", selectedDate);
                    if($("#sto").val() == '') {
                        $("#sto").val($("#sfrom").val());
                    }
                });
                ...
                $("#sto").datepicker({
                    ...
                    $("#sfrom").datepicker("option", "endDate", selectedDate);
                });
...
function export_data(com, grid) {
    ...
    $("#export_column_name").val(JSON.stringify(arr_column_name));
    $("#export_column_title").val(JSON.stringify(arr_column_title));
    $("#export_column_show").val(JSON.stringify(arr_column_show));
    $("#export_column_align").val(JSON.stringify(arr_column_align));
    $("#export_sortname").val(sortname);
    $("#export_sortorder").val(sortorder);
    $("#export_query").val(query);
    $("#export_optionused").val(optionused);
    $("#export_option").val(option);
    $("#export_date_start").val(date_start);
    $("#export_date_end").val(date_end);
    $("#export_qtype").val(qtype);
    $("#form_export").submit();
}

function export_data_limit(com, grid) {
    var arr_column_name = [{}];
    var arr_column_title = [{}];
    var arr_column_show = [{}];
    var arr_column_align = [{}];
