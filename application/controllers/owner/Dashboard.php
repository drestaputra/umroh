...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array();
		$where_koperasi = ' id_owner = '.$this->db->escape($id_user).'';
		...
		$this->load->view('owner/dashboard/index',$dataView,false);	
	}
	public function get_grafik_user(){
		...
		$bulanNasabah = $bulan;		
		$dataNasabah = $this->Mowner->get_grafik_user_nasabah($tahun,$id_user);	
	...
	public function get_grafik_transaksi(){
		...
		$this->load->model('Mowner');
		$id_owner = $id_user;
		$riwayat_pinjman = $this->Mowner->get_grafik_riwayat_pinjaman(date("m"),$id_owner);
		$riwayat_simpanan = $this->Mowner->get_grafik_riwayat_simpanan(date("m"),$id_owner);
		$hari_pinjaman = array();
		$hari_simpanan = array();
